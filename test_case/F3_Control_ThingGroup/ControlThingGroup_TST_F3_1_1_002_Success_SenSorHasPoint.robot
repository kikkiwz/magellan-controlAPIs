...
*** Test Cases ***
ControlThingGroup_TST_F3_1_1_002_Success_SenSorHasPoint
	...
	Log ControlThingGroup      ${VALUE_RESULTCODE_20000}    ${VALUE_DESCRIPTION_CREATECONTROLTHINGGROUP_SUCCESS}    ${res}    ${URL_CREATECONTROLTHINGGROUP}    ${dataSearch}    ${accessToken}    ${AccountId}    ${GroupId}    ${VALUE_SENSORKEY_POINT}    ${sensorValue}      

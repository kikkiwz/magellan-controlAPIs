...
*** Test Cases ***
ControlThingGroups_TST_F4_0_2_003_Error_ThingGroupNotObjectId
    ...
    ${GroupId}=    Set Variable    5f719410226bf9000127a1eexx
    #====== End Prepare data ==========  
    ...
    ${checkReponse}=    Run keyword And Continue On Failure    Response ResultCode Should Have Error    ${res}    ${VALUE_RESULTCODE_40300}    ${VALUE_RESULTDESC_THINGGROUP_NOT_OBJECTID}
    Log To Console    checkReponse is : ${checkReponse}
	#====== Check log and Verify DB ==========
	${dataSearch}=    Set Variable    ${HEADER_X_AIS_ORDERREF_CREATECONTROLTHINGGROUPS}${current_timestamp}
	#Check log detail and summary
	Log ControlThingGroups      ${VALUE_RESULTCODE_40300}    ${VALUE_RESULTDESC_THINGGROUP_NOT_OBJECTID}    ${res}    ${URL_CREATECONTROLTHINGGROUPS}    ${dataSearch}    ${accessToken}    ${AccountId}    ${GroupId}    ${VALUE_SENSORKEY}    ${sensorValue}      

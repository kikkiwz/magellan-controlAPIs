...
ControlThingGroup_TST_F3_0_2_004_Error_ThingGroupIdNotFound
    ...
    ${GroupId}=    Set Variable    5f719410226bf9000127a1ee
    #====== End Prepare data ==========    
	...
	Log ControlThingGroups      ${VALUE_RESULTCODE_40400}    ${VALUE_RESULTDESC_THINGGROUP_NOT_FOUND}    ${res}    ${URL_CREATECONTROLTHINGGROUPS}    ${dataSearch}    ${accessToken}    ${AccountId}    ${GroupId}    ${VALUE_SENSORKEY}    ${sensorValue}      

...
*** Test Cases ***
ControlThingGroups_TST_F4_1_1_001_Success
	...
	Log ControlThingGroups      ${VALUE_RESULTCODE_20000}    ${VALUE_DESCRIPTION_CREATECONTROLTHINGGROUPS_SUCCESS}    ${res}    ${URL_CREATECONTROLTHINGGROUPS}    ${dataSearch}    ${accessToken}    ${AccountId}    ${GroupId}    ${VALUE_SENSORKEY}    ${sensorValue}      

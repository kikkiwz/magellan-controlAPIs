...
*** Test Cases ***
ControlThing_TST_F1_0_2_004_Error_ThingIdNotFound
	...
	Log ControlThing      ${VALUE_RESULTCODE_40400}    ${VALUE_RESULTDESC_THING_NOT_FOUND}    ${res}    ${URL_CREATECONTROLTHING}    ${dataSearch}    ${accessToken}    ${AccountId}    ${ThingId}    ${VALUE_SENSORKEY}    ${sensorValue}

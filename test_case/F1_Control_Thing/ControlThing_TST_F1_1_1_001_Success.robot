...
*** Test Cases ***
ControlThing_TST_F1_1_1_001_Success
	...
	Log ControlThing      ${VALUE_RESULTCODE_20000}    ${VALUE_DESCRIPTION_CREATECONTROLTHING_SUCCESS}    ${res}    ${URL_CREATECONTROLTHING}    ${dataSearch}    ${accessToken}    ${AccountId}    ${ThingId}    ${VALUE_SENSORKEY}    ${sensorValue}

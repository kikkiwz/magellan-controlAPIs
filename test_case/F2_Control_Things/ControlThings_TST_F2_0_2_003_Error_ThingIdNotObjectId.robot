...
*** Test Cases ***
ControlThings_TST_F2_0_2_003_Error_ThingIdNotObjectId
    ...
    ${ThingId}=    Set Variable    5f719410226bf9000127a1eexx
	...
	Log ControlThings      ${VALUE_RESULTCODE_40300}    ${VALUE_RESULTDESC_THING_NOT_OBJECTID}    ${res}    ${URL_CREATECONTROLTHINGS}    ${dataSearch}    ${accessToken}    ${AccountId}    ${ThingId}    ${VALUE_SENSORKEY_POINT}    ${sensorValue}      

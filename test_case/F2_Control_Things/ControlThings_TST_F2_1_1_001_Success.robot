...
*** Test Cases ***
ControlThings_TST_F2_1_1_001_Success
	...
	Log ControlThings      ${VALUE_RESULTCODE_20000}    ${VALUE_DESCRIPTION_CREATECONTROLTHINGS_SUCCESS}    ${res}    ${URL_CREATECONTROLTHINGS}    ${dataSearch}    ${accessToken}    ${AccountId}    ${ThingId}    ${VALUE_SENSORKEY}    ${sensorValue} 
